...
class StructureLogger {
  ...
  Future<void> log(
    ...
    // Snapshot to avoid ConcurrentModificationError if addSink/removeSink
    // called reentrantly during await write() (public API contract).
    final sinks = List.of(_sinks);
